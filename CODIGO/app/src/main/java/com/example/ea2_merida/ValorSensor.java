...
public class ValorSensor extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_valor_sensor);
        ...
        SharedPreferences prefs = getSharedPreferences("acelerometro", Context.MODE_PRIVATE);
        ...
        synchronized (this){
            switch (event.sensor.getType()){
                case Sensor.TYPE_ACCELEROMETER:
                    ...
                    i++;
                    if(i % 2 == 0){
                        guardarPreferencias(Sen_acelerometro, txt, true, g);
                        if ( g == 3)
                            g = 0;
                        else
                            g++;
                ...
                case Sensor.TYPE_PROXIMITY:
                    ...
                    guardarPreferencias(Sen_proximidad, txt2, false, j);
                    j++;
                    if(j == 3)
                        j = 0;
                    break;
